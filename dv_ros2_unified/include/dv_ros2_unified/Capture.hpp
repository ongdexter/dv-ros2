...
#include "dv_ros2_unified/Reader.hpp"
...
namespace dv_ros2_unified
{
    ...
    public:
        ...
        // GIANNIS: hoping this actually works for components
        explicit Capture(const rclcpp::NodeOptions &options);

        /// @brief Default constructor
        /// @param t_node_name name of the node
        void capture_ctor(std::string t_node_name);
